...
module ex(
  ...
  assign excepttype_o = {excepttype_i[31:11],trapassert,excepttype_i[9:8],int_i};
	...
	assign reg2_i_mux = ((aluop_i == `EXE_SUB_OP) || (aluop_i == `EXE_SUBU_OP) ||
											 (aluop_i == `EXE_SLT_OP) || (aluop_i == `EXE_SLTU_OP)) 
											 ? (~reg2_i)+1 : reg2_i;
